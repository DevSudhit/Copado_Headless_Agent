...
exports.StoryDetailPanel = void 0;
const vscode = __importStar(require("vscode"));
class StoryDetailPanel {
    static currentPanel;
    panel;
    disposables = [];
    static createOrShow(extensionUri, storyId, data) {
        ...
        const panel = vscode.window.createWebviewPanel('copadoStoryDetail', `Story: ${storyId}`, column, { enableScripts: false });
        StoryDetailPanel.currentPanel = new StoryDetailPanel(panel, storyId, data);
    }
    constructor(panel, storyId, data) {
        this.panel = panel;
...
exports.StoryDetailPanel = StoryDetailPanel;
//# sourceMappingURL=story-detail-panel.js.map